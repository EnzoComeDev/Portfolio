...
Étudiant en **L3 Informatique** à l'Université d'Angers, je partage ici mes projets réalisés dans le cadre de mes études et de compétitions informatiques. Chaque projet m'a permis de découvrir de nouvelles technologies et d'améliorer mes compétences en programmation et conception.
...
Objectif : Développer progressivement **toutes les compétences nécessaires à la création d’un jeu complet** :  
- maîtrise de Unity et C#  
- conception de gameplay et game design  
- gestion des événements et interactions  
- structuration et architecture d’un projet de jeu
